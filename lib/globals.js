...
/**
 * @description Attaches {@link debaser} and {@link debase} to the `window` object.  Registers
 * `setup()`/`teardown()` or `beforeEach()`/`afterEach()` functions to retrieve the current spec.
 * @private
 */
